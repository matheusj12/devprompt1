  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'neon-intense': '0 0 30px rgba(0, 255, 148, 0.4), 0 0 60px rgba(0, 255, 148, 0.2)',
        'neon-subtle': '0 0 10px rgba(0, 255, 148, 0.2)',
        'dark': '0 10px 30px rgba(0, 0, 0, 0.5)',
        'dark-lg': '0 20px 50px rgba(0, 0, 0, 0.6)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
