...
import { Plus, BookOpen, ArrowRight, Zap, Save, FileText, Sparkles, LayoutTemplate } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section 
        className="container mx-auto px-6 py-20 md:py-28 text-center"
        style={{
      ...
      >
        ...
        {/* Description */}
        <p 
          className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto mb-12 animate-fade-in"
          style={{ 
            lineHeight: '1.6',
            animationDelay: '0.1s'
          }}
        ...
        {hasDraft && (
          <div className="futuristic-card p-5 max-w-xl mx-auto mb-10 flex items-center justify-between gap-4 animate-fade-in border-warning/30" style={{ animationDelay: '0.15s' }}>
